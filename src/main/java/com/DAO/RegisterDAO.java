...
public class RegisterDAO {
	...
	{
		String smt = "INSERT INTO users(username,password,enabled) VALUES(?,?,?)";
		String smt2 = "INSERT INTO user_roles(username,role) VALUES('"+reg.getUsername()+"','ROLE_USER')";
		String smt3 = "INSERT INTO profiles(username,first_name,last_name) VALUES(?,?,?)";
		jdbcTemplate.update(smt, new Object[]{reg.getUsername(),reg.getPassword(),reg.getEnabled()});
